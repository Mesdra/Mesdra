...
public class KaaTest{
    ...
    private static int getTemperatureRand() {
        return new Random().nextInt(10) + 500;
    }
        ...
        scheduledFuture = scheduledExecutorService.scheduleAtFixedRate(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        kaaClient.addLogRecord(new DataCollection("Estaçao de teste","05/07/2018","temperatura "+temperature+"|humidade"));
    ...
    private static void onChangedConfiguration(long time) {
        ...
        scheduledFuture = scheduledExecutorService.scheduleAtFixedRate(
                new Runnable() {
                    ...
                    public void run() {
                        int temperature = getTemperatureRand();
                        kaaClient.addLogRecord(new DataCollection("Estaçao de teste","05/07/2018","temperatura %d"+temperature+"|humidade"));
                        LOG.info("Sampled Temperature: {}", temperature);
                    }
                }, 0, time, TimeUnit.MILLISECONDS);
    }
